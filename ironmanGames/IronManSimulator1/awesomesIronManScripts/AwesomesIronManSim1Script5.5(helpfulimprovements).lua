...
God.MouseButton1Click:connect(function()
	...
	local Value = game:GetService("Workspace").XxDaServerKingxX.Suit.Status.Charge.Value --change XxDaServerKingxX to your exact username, not display name
	local suit = game:GetService("Workspace").XxDaServerKingxX.Suit.Status.Model.Value
	local number = 1
while number == 1 do
	if Value < 25 then
		game.Players.LocalPlayer.Backpack.suitControl.Assets.Events.Eject:FireServer()
		...
		wait(0.2)
		game:GetService("Players").LocalPlayer.Backpack.ironMan.Assets.Events.callSuit:FireServer(suit, 0.6, 0)
		wait(0.1)
		game.Players.LocalPlayer.Backpack.ironMan.Assets.Events.callPiece:FireServer('Mask')
		game.Players.LocalPlayer.Backpack.ironMan.Assets.Events.callPiece:FireServer('Helmet')
		game.Players.LocalPlayer.Backpack.ironMan.Assets.Events.callPiece:FireServer('UpperTorso')
