...
local Suits = Instance.new("Frame")
local SuitID = Instance.new("TextBox")
local CallSuit = Instance.new("TextButton")
local TextLabel2 = Instance.new("TextLabel")
local OpenSuitIDs = Instance.new("TextButton")
local CloseSuitIDs = Instance.new("TextButton")
local SuitIDs = Instance.new("Frame")
local SuitIDsAndColors = Instance.new("TextLabel")
...
local extraOpen = Instance.new("Frame")
...
local KillPeople = Instance.new("Frame")
local Person1 = Instance.new("TextBox")
local Person2 = Instance.new("TextBox")
local Person4 = Instance.new("TextBox")
local Person3 = Instance.new("TextBox")
local Person6 = Instance.new("TextBox")
local Person5 = Instance.new("TextBox")
local KillPeople_2 = Instance.new("TextButton")
local CloseKillPeople = Instance.new("TextButton")
local OpenKillPeople = Instance.new("TextButton")
local esp_settings = {
	textsize = 10,
	colour = 255,255,255
}
...
Suits.Name = "Suits"
Suits.Parent = main
Suits.BackgroundColor3 = Color3.new(0, 0, 1)
Suits.Position = UDim2.new(-0.714506686, 0, 0.00289316243, 0)
Suits.Size = UDim2.new(0, 283, 0, 253)
Suits.Visible = false

SuitID.Name = "SuitID"
SuitID.Parent = Suits
SuitID.BackgroundColor3 = Color3.new(1, 1, 1)
SuitID.Position = UDim2.new(0.325754195, 0, 0.637624085, 0)
SuitID.Size = UDim2.new(0, 96, 0, 22)
SuitID.Font = Enum.Font.SourceSans
SuitID.Text = ""
SuitID.TextColor3 = Color3.new(0, 0, 0)
SuitID.TextSize = 14

CallSuit.Name = "CallSuit"
CallSuit.Parent = Suits
CallSuit.BackgroundColor3 = Color3.new(1, 1, 1)
CallSuit.Position = UDim2.new(0.392181724, 0, 0.460349798, 0)
CallSuit.Size = UDim2.new(0, 60, 0, 17)
CallSuit.Font = Enum.Font.SourceSans
CallSuit.Text = "Call Suit"
CallSuit.TextColor3 = Color3.new(0, 0, 0)
CallSuit.TextSize = 14
CallSuit.MouseButton1Down:connect(function()
	local SuitCallingID = SuitID.Text
	game:GetService("Players").LocalPlayer.Backpack.ironMan.Assets.Events.callSuit:FireServer(SuitCallingID, 0.6, 0)
	wait(0.1)
	game.Players.LocalPlayer.Backpack.ironMan.Assets.Events.callPiece:FireServer('Mask')
	game.Players.LocalPlayer.Backpack.ironMan.Assets.Events.callPiece:FireServer('Helmet')
	game.Players.LocalPlayer.Backpack.ironMan.Assets.Events.callPiece:FireServer('UpperTorso')
...
TextLabel2.Parent = Suits
TextLabel2.BackgroundColor3 = Color3.new(1, 1, 1)
TextLabel2.Position = UDim2.new(0.230117008, 0, 0.125657454, 0)
TextLabel2.Size = UDim2.new(0, 150, 0, 33)
TextLabel2.Font = Enum.Font.SourceSans
TextLabel2.Text = "Put the suit's EXACT name in and press \"call suit\""
TextLabel2.TextColor3 = Color3.new(0, 0, 0)
TextLabel2.TextScaled = true
TextLabel2.TextSize = 14
TextLabel2.TextWrapped = true

OpenSuitIDs.Name = "OpenSuitIDs"
OpenSuitIDs.Parent = Suits
OpenSuitIDs.BackgroundColor3 = Color3.new(1, 1, 1)
OpenSuitIDs.Position = UDim2.new(0.366345942, 0, 0.838489294, 0)
OpenSuitIDs.Size = UDim2.new(0, 74, 0, 17)
OpenSuitIDs.Font = Enum.Font.SourceSans
OpenSuitIDs.Text = "Open Suit IDs"
OpenSuitIDs.TextColor3 = Color3.new(0, 0, 0)
OpenSuitIDs.TextSize = 14
OpenSuitIDs.MouseButton1Down:connect(function()
	OpenSuitIDs.Visible = false
	CloseSuitIDs.Visible = true
	SuitIDs.Visible = true
end)

CloseSuitIDs.Name = "CloseSuitIDs"
CloseSuitIDs.Parent = Suits
CloseSuitIDs.BackgroundColor3 = Color3.new(1, 1, 1)
CloseSuitIDs.Position = UDim2.new(0.366345942, 0, 0.838489294, 0)
CloseSuitIDs.Size = UDim2.new(0, 74, 0, 17)
CloseSuitIDs.Visible = false
CloseSuitIDs.Font = Enum.Font.SourceSans
CloseSuitIDs.Text = "Close Suit IDs"
CloseSuitIDs.TextColor3 = Color3.new(0, 0, 0)
CloseSuitIDs.TextSize = 14
CloseSuitIDs.MouseButton1Down:connect(function()
	OpenSuitIDs.Visible = true
	CloseSuitIDs.Visible = false
	SuitIDs.Visible = false
end)

SuitIDs.Name = "SuitIDs"
SuitIDs.Parent = Suits
SuitIDs.BackgroundColor3 = Color3.new(0, 0, 1)
SuitIDs.Position = UDim2.new(-0.00229948759, 0, 1, 0)
SuitIDs.Size = UDim2.new(0, 484, 0, 329)
SuitIDs.Visible = false

SuitIDsAndColors.Name = "SuitIDsAndColors"
SuitIDsAndColors.Parent = SuitIDs
SuitIDsAndColors.BackgroundColor3 = Color3.new(0, 0, 0.498039)
SuitIDsAndColors.Position = UDim2.new(0.0117794871, 0, 0.0264545679, 0)
SuitIDsAndColors.Size = UDim2.new(0, 472, 0, 308)
SuitIDsAndColors.Font = Enum.Font.SourceSans
SuitIDsAndColors.Text = "WarMachine1 - war machine\nMark 2 - steel\nMark 3 - golden and red, kinda like original suit but darker yellow\nMark 4 - looks exactly like 3 might be a difference\nMark 6 - same as 3, little different, triangle core.\nMark 9 - looks like its the same as 6 but circle core and maybe more armor?\nMark 12 - same as 20 but with less gold and some silver\nMark 13 - kinda like mark 2 but with square core (fav for now)\nMark 14 - like 9 but all black also kinda looks like war machine\nMark 19 - silver red and golden, gold forehead, red mid part, and silver jaw\nMark 20 - looks like 9, but black and a brownish gold\nMark 21 - gold suit, kinda like 9\nMark 23 - blueish camo, cool lookin, square core\nMark 27 - dark blue for main, orange for other kinda cool lookin!\nMark 28 - orange and black, both very dark. some silver\nMark 30 - looks like 33, but light blue, does lots of damage, not as much as mark 33 tho\nMark 31 - looks like 6 but teal and silver\nMark 33 - looks like 6 but silver and red VERY STRONG SUIT\nMark 40 - looks like 6, but very dark gold and dark silver JESUS HIS MAX SPEED IS 1000 SPS!\n"
SuitIDsAndColors.TextColor3 = Color3.new(1, 1, 1)
SuitIDsAndColors.TextSize = 14
SuitIDsAndColors.TextXAlignment = Enum.TextXAlignment.Left

ScrollingFrame.Parent = main
ScrollingFrame.Active = true
ScrollingFrame.BackgroundColor3 = Color3.new(0, 0, 1)
ScrollingFrame.Position = UDim2.new(-1.188, 0, 0, 0)
...
extraOpen.Parent = ScreenGui
extraOpen.BackgroundColor3 = Color3.new(1, 1, 1)
extraOpen.Position = UDim2.new(0, 0, 0.464327484, 0)
extraOpen.Size = UDim2.new(0, 74, 0, 17)

OpenExtra.Name = "OpenExtra"
OpenExtra.Parent = extraOpen
OpenExtra.BackgroundColor3 = Color3.new(1, 1, 1)
OpenExtra.Position = UDim2.new(0.0135135138, 0, -0.00626075268, 0)
OpenExtra.Size = UDim2.new(0, 73, 0, 17)
OpenExtra.Font = Enum.Font.SourceSans
OpenExtra.Text = "Open Extras"
OpenExtra.TextColor3 = Color3.new(0, 0, 0)
OpenExtra.TextSize = 14
OpenExtra.MouseButton1Down:connect(function()
	extraOpen.Visible = false
	Extra.Visible = true
end)

Extra.Name = "Extra"
Extra.Parent = ScreenGui
Extra.BackgroundColor3 = Color3.new(0, 0.333333, 1)
Extra.Position = UDim2.new(0.0172684491, 0, 0.549707651, 0)
Extra.Size = UDim2.new(0, 834, 0, 330)
Extra.Visible = false
Extra.Draggable = true

ExtraTextLabel.Name = "ExtraTextLabel"
ExtraTextLabel.Parent = Extra
ExtraTextLabel.BackgroundColor3 = Color3.new(1, 0, 0)
ExtraTextLabel.Size = UDim2.new(0, 834, 0, 25)
ExtraTextLabel.Font = Enum.Font.SourceSans
ExtraTextLabel.Text = "Extra's"
ExtraTextLabel.TextColor3 = Color3.new(0, 0, 0)
ExtraTextLabel.TextScaled = true
ExtraTextLabel.TextSize = 14
ExtraTextLabel.TextWrapped = true

CloseExtra.Name = "CloseExtra"
CloseExtra.Parent = ExtraTextLabel
CloseExtra.BackgroundColor3 = Color3.new(1, 1, 1)
CloseExtra.Position = UDim2.new(0.967010438, 0, -0.0238598641, 0)
CloseExtra.Size = UDim2.new(0, 27, 0, 25)
CloseExtra.Font = Enum.Font.SourceSans
CloseExtra.Text = "X"
CloseExtra.TextColor3 = Color3.new(0, 0, 0)
CloseExtra.TextScaled = true
CloseExtra.TextSize = 14
CloseExtra.TextWrapped = true
CloseExtra.MouseButton1Down:connect(function()
	extraOpen.Visible = true
	Extra.Visible = false
end)

CloseKillPeople.Name = "CloseKillPeople"
CloseKillPeople.Parent = Extra
CloseKillPeople.BackgroundColor3 = Color3.new(1, 1, 1)
CloseKillPeople.Position = UDim2.new(0.836218953, 0, 0.186337009, 0)
CloseKillPeople.Size = UDim2.new(0, 93, 0, 17)
CloseKillPeople.Visible = false
CloseKillPeople.Font = Enum.Font.SourceSans
CloseKillPeople.Text = "Close Kill People"
CloseKillPeople.TextColor3 = Color3.new(0, 0, 0)
CloseKillPeople.TextSize = 14
CloseKillPeople.Visible = false
CloseKillPeople.MouseButton1Click:connect(function()
	CloseKillPeople.Visible = false
	OpenKillPeople.Visible = true
	KillPeople.Visible = false
end)

OpenKillPeople.Name = "OpenKillPeople"
OpenKillPeople.Parent = Extra
OpenKillPeople.BackgroundColor3 = Color3.new(1, 1, 1)
OpenKillPeople.Position = UDim2.new(0.836218953, 0, 0.186337009, 0)
OpenKillPeople.Size = UDim2.new(0, 93, 0, 17)
OpenKillPeople.Font = Enum.Font.SourceSans
OpenKillPeople.Text = "Open Kill People"
OpenKillPeople.TextColor3 = Color3.new(0, 0, 0)
OpenKillPeople.TextSize = 14
OpenKillPeople.MouseButton1Down:connect(function()
	CloseKillPeople.Visible = true
	OpenKillPeople.Visible = false
	KillPeople.Visible = true
end)


KillPeople.Name = "KillPeople"
KillPeople.Parent = Extra
KillPeople.BackgroundColor3 = Color3.new(0, 0.333333, 1)
KillPeople.Position = UDim2.new(0.999237657, 0, -0.00180756545, 0)
KillPeople.Size = UDim2.new(0, 314, 0, 330)
KillPeople.Visible = false

Person1.Name = "Person 1"
Person1.Parent = KillPeople
Person1.BackgroundColor3 = Color3.new(1, 1, 1)
Person1.Position = UDim2.new(0.154554129, 0, 0.357575774, 0)
Person1.Size = UDim2.new(0, 79, 0, 17)
Person1.Font = Enum.Font.SourceSans
Person1.Text = ""
Person1.TextColor3 = Color3.new(0, 0, 0)
Person1.TextSize = 14

Person2.Name = "Person 2"
Person2.Parent = KillPeople
Person2.BackgroundColor3 = Color3.new(1, 1, 1)
Person2.Position = UDim2.new(0.59085989, 0, 0.357575774, 0)
Person2.Size = UDim2.new(0, 79, 0, 17)
Person2.Font = Enum.Font.SourceSans
Person2.Text = ""
Person2.TextColor3 = Color3.new(0, 0, 0)
Person2.TextSize = 14

Person4.Name = "Person 4"
Person4.Parent = KillPeople
Person4.BackgroundColor3 = Color3.new(1, 1, 1)
Person4.Position = UDim2.new(0.59085989, 0, 0.481818199, 0)
Person4.Size = UDim2.new(0, 79, 0, 17)
Person4.Font = Enum.Font.SourceSans
Person4.Text = ""
Person4.TextColor3 = Color3.new(0, 0, 0)
Person4.TextSize = 14

Person3.Name = "Person 3"
Person3.Parent = KillPeople
Person3.BackgroundColor3 = Color3.new(1, 1, 1)
Person3.Position = UDim2.new(0.154554129, 0, 0.481818199, 0)
Person3.Size = UDim2.new(0, 79, 0, 17)
Person3.Font = Enum.Font.SourceSans
Person3.Text = ""
Person3.TextColor3 = Color3.new(0, 0, 0)
Person3.TextSize = 14

Person6.Name = "Person 6"
Person6.Parent = KillPeople
Person6.BackgroundColor3 = Color3.new(1, 1, 1)
Person6.Position = UDim2.new(0.59085989, 0, 0.593939424, 0)
Person6.Size = UDim2.new(0, 79, 0, 17)
Person6.Font = Enum.Font.SourceSans
Person6.Text = ""
Person6.TextColor3 = Color3.new(0, 0, 0)
Person6.TextSize = 14

Person5.Name = "Person 5"
Person5.Parent = KillPeople
Person5.BackgroundColor3 = Color3.new(1, 1, 1)
Person5.Position = UDim2.new(0.154554129, 0, 0.593939424, 0)
Person5.Size = UDim2.new(0, 79, 0, 17)
Person5.Font = Enum.Font.SourceSans
Person5.Text = ""
Person5.TextColor3 = Color3.new(0, 0, 0)
Person5.TextSize = 14

KillPeople_2.Name = "KillPeople"
KillPeople_2.Parent = KillPeople
KillPeople_2.BackgroundColor3 = Color3.new(1, 1, 1)
KillPeople_2.Position = UDim2.new(0.29502511, 0, 0.187878788, 0)
KillPeople_2.Size = UDim2.new(0, 128, 0, 33)
KillPeople_2.Font = Enum.Font.SourceSans
KillPeople_2.Text = "Kill"
KillPeople_2.TextColor3 = Color3.new(0, 0, 0)
KillPeople_2.TextSize = 14
KillPeople_2.MouseButton1Down:connect(function()
	local punchevent = game.Players.LocalPlayer.Backpack.suitControl.Assets.Events.punchHit
	local vector = Vector3.new(0, 0, 0) 
	local dmg = 1000000000000
	
	for i,v in pairs(game.Players:GetChildren()) do
		if Person1.Text == v.Name then
			punchevent:FireServer(v.Character.HumanoidRootPart, dmg)
		end
	end
	for i,v in pairs(game.Players:GetChildren()) do
		if Person2.Text == v.Name then
			punchevent:FireServer(v.Character.HumanoidRootPart, dmg)
		end
	end
	for i,v in pairs(game.Players:GetChildren()) do
		if Person3.Text == v.Name then
			punchevent:FireServer(v.Character.HumanoidRootPart, dmg)
		end
	end
	for i,v in pairs(game.Players:GetChildren()) do
		if Person4.Text == v.Name then
			punchevent:FireServer(v.Character.HumanoidRootPart, dmg)
		end
	end
	for i,v in pairs(game.Players:GetChildren()) do
		if Person5.Text == v.Name then
			punchevent:FireServer(v.Character.HumanoidRootPart, dmg)
		end
	end
	for i,v in pairs(game.Players:GetChildren()) do
		if Person6.Text == v.Name then
			punchevent:FireServer(v.Character.HumanoidRootPart, dmg)
		end
	end
end)
